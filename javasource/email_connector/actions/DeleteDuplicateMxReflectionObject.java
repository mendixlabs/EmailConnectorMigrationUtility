...
public class DeleteDuplicateMxReflectionObject extends CustomJavaAction<java.lang.Void>
{
	...
	private java.util.List<IMendixObject> __MxObjectMemberList;
	private java.util.List<mxmodelreflection.proxies.MxObjectMember> MxObjectMemberList;
	private java.util.List<IMendixObject> __MxObjectReferenceList;
	private java.util.List<mxmodelreflection.proxies.MxObjectReference> MxObjectReferenceList;
	private java.util.List<IMendixObject> __MxObjectTypeList;
	private java.util.List<mxmodelreflection.proxies.MxObjectType> MxObjectTypeList;
	private java.util.List<IMendixObject> __EmailTemplateList;
	private java.util.List<email_connector.proxies.EmailTemplate> EmailTemplateList;

	public DeleteDuplicateMxReflectionObject(IContext context, java.util.List<IMendixObject> TokenList, java.util.List<IMendixObject> MxObjectMemberList, java.util.List<IMendixObject> MxObjectReferenceList, java.util.List<IMendixObject> MxObjectTypeList, java.util.List<IMendixObject> EmailTemplateList)
	{
		super(context);
