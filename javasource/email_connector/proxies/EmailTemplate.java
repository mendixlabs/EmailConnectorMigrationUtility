...
public class EmailTemplate
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Email_Connector.EmailTemplate"));
	}
	...
	protected EmailTemplate(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject emailTemplateMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("Email_Connector.EmailTemplate", emailTemplateMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Email_Connector.EmailTemplate");
	...
	public static email_connector.proxies.EmailTemplate initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return email_connector.proxies.EmailTemplate.load(context, mendixIdentifier);
	}
	...
	{
		java.util.List<email_connector.proxies.EmailTemplate> result = new java.util.ArrayList<email_connector.proxies.EmailTemplate>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//Email_Connector.EmailTemplate" + xpathConstraint))
			result.add(email_connector.proxies.EmailTemplate.initialize(context, obj));
		return result;
	}
	...
	{
		return "Email_Connector.EmailTemplate";
	}
